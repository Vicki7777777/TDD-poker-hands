...
public class PokerHandsTest {
    ...
    @Test
    public void should_white_win_when_handleFullHouse_given_3H3D3C6H6D_3H3D3C5H5D() {
        //given
        String[] white = {"3H", "3D", "3C", "6H", "6D"};
        String[] black = {"3H", "3D", "3C", "5H", "5D"};
        //when
        PokerHands pokerHands = new PokerHands();
        String result = pokerHands.handleFullHouse(black, white);
        //then
    ...
    @Test
    public void should_white_win_when_handleFourOfAKind_given_3H3D3C3H6D_3H3D3C5H5D() {
        //given
    ...
    @Test
    public void should_black_win_when_handleFourOfAKind_given_3H3D3C3H6D_4H4D4C4H6D() {
        //given
        String[] white = {"3H", "3D", "3C", "3H", "6D"};
        String[] black = {"4H", "4D", "4C", "4H", "6D"};
        //when
        PokerHands pokerHands = new PokerHands();
        String result = pokerHands.handleFourOfAKind(black, white);
        //then
    ...
    @Test
    public void should_tie_when_handleFourOfAKind_given_3H3D3C3H6D_3H3D3C3H6D() {
        //given
        String[] white = {"3H", "3D", "3C", "3H", "6D"};
        String[] black = {"3H", "3D", "3C", "3H", "6D"};
        //when
        PokerHands pokerHands = new PokerHands();
        String result = pokerHands.handleFourOfAKind(black, white);
        //then
    ...
    @Test
    public void black_win_when_handleStraightFlush_given_3H3D3C3H6D_3C4C5C6C7C() {
        //given
        String[] white = {"3H", "3D", "3C", "3H", "6D"};
